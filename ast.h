...
public:
    Exp* value;
    string targetType; // p. ej. "usize"

    CastExp(Exp* v, const string& t);
    ~CastExp();
...
// ============================================================
// Address-of / referencia:  &expr  o  &mut expr
// ============================================================
...
// ============================================================
// Asignación dinámica en heap:  Box::new(expr)
// ============================================================
...
// ============================================================
// Expresión de cadena (string literal)
// ============================================================
