...
public:
    ...
    static bool is_numeric(TType tt) {
        return tt == I32 || tt == I64 || tt == U32 || tt == U64 || tt == USIZE || tt == F32 || tt == F64;
    }
...
inline const char* Type::type_names[11] = { "notype", "void", "bool", "i32", "i64", "u32", "u64", "usize", "f32", "f64", "String" };
