...
// ------------------ ArrayRepeatExp ------------------
ArrayRepeatExp::ArrayRepeatExp(Exp* v, int c) : value(v), count(c) {}
ArrayRepeatExp::~ArrayRepeatExp() { delete value; }
int ArrayRepeatExp::accept(Visitor* visitor) { return visitor->visit(this); }

// ------------------ CastExp ------------------
CastExp::CastExp(Exp* v, const string& t) : value(v), targetType(t) {}
CastExp::~CastExp() { delete value; }
...
// ------------------ AddressOfExp ------------------
AddressOfExp::AddressOfExp(Exp* t, bool m) : target(t), isMut(m) {}
AddressOfExp::~AddressOfExp() { delete target; }
...
int DerefExp::accept(Visitor* visitor) { return visitor->visit(this); }
